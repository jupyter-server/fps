...
- Drop `anyioutils` [#156](https://github.com/jupyter-server/fps/pull/156) ([@davidbrochart](https://github.com/davidbrochart))
...
- Drop `importlib_metadata` [#152](https://github.com/jupyter-server/fps/pull/152) ([@davidbrochart](https://github.com/davidbrochart))
- Update trio requirement from \<0.33,>=0.32.0 to >=0.32.0,\<0.34 [#151](https://github.com/jupyter-server/fps/pull/151) ([@davidbrochart](https://github.com/davidbrochart))
...
([Full Changelog](https://github.com/jupyter-server/fps/compare/v0.5.9...39c7bdece990a808addd2a95e660bddabd82d0d4))

### Merged PRs

- Add module `prepared` and `stopped` properties, remove ability to manage shared values [#150](https://github.com/jupyter-server/fps/pull/150) ([@davidbrochart](https://github.com/davidbrochart))
...
([GitHub contributors page for this release](https://github.com/jupyter-server/fps/graphs/contributors?from=2026-01-07&to=2026-01-29&type=c))

@davidbrochart ([activity](https://github.com/search?q=repo%3Ajupyter-server%2Ffps+involves%3Adavidbrochart+updated%3A2026-01-07..2026-01-29&type=Issues))
...
- Add `FastAPIModule` `routes_url` and `openapi_url` parameters [#148](https://github.com/jupyter-server/fps/pull/148) ([@davidbrochart](https://github.com/davidbrochart))
...
([GitHub contributors page for this release](https://github.com/jupyter-server/fps/graphs/contributors?from=2025-12-18&to=2026-01-07&type=c))
...
- Fix value types in logging [#140](https://github.com/jupyter-server/fps/pull/140) ([@davidbrochart](https://github.com/davidbrochart))
